 ...
 */
    ...
    class ai_underutilised_status_hintPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Ai Underutilised Status Hint');
            $this->SetMenuLabel('Underutilised Status Hint');
    ...
    try
    {
        $Page = new ai_underutilised_status_hintPage("ai_underutilised_status_hint", "ai_underutilised_status_hint.php", GetCurrentUserPermissionSetForDataSource("ai_underutilised_status_hint"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ai_underutilised_status_hint"));

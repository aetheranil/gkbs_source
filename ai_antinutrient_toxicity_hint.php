 ...
 */
    ...
    class ai_antinutrient_toxicity_hintPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Ai Antinutrient Toxicity Hint');
            $this->SetMenuLabel('Antinutrient Toxicity Hint');
    ...
    try
    {
        $Page = new ai_antinutrient_toxicity_hintPage("ai_antinutrient_toxicity_hint", "ai_antinutrient_toxicity_hint.php", GetCurrentUserPermissionSetForDataSource("ai_antinutrient_toxicity_hint"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ai_antinutrient_toxicity_hint"));

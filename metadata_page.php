 ...
 */
    ...
    class metadata_alt01_document1_idNestedPage extends NestedFormPage
    {
    ...
    class metadata_alt01_document2_idNestedPage extends NestedFormPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
    ...
    class metadata_alt01_document3_idNestedPage extends NestedFormPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
    ...
    class metadata_alt01Page extends Page
    {
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            //
            // Edit column for document1_id field
            //
            $editor = new DynamicCombobox('document1_id_edit', $this->CreateLinkBuilder());
            $editor->setAllowClear(true);
            $editor->setMinimumInputLength(0);
            $lookupDataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Document', 'document1_id', 'document1_id_id', 'insert_metadata_alt01_document1_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'id', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(metadata_alt01_document1_idNestedPage::getNestedInsertHandlerName())
            );
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('accuracy_flag', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Accuracy Flag', 'acc_flag2_id', 'acc_flag2_id_accuracy_flag', '_metadata_alt01_acc_flag2_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'accuracy_flag', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('google_address', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Location', 'location2_id', 'location2_id_google_address', '_metadata_alt01_location2_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'google_address', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            
            //
            // Edit column for document2_id field
            //
            $editor = new DynamicCombobox('document2_id_edit', $this->CreateLinkBuilder());
            $editor->setAllowClear(true);
            $editor->setMinimumInputLength(0);
            $lookupDataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Document', 'document2_id', 'document2_id_id', '_metadata_alt01_document2_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'id', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(metadata_alt01_document2_idNestedPage::getNestedInsertHandlerName())
            );
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('accuracy_flag', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Accuracy Flag', 'acc_flag3_id', 'acc_flag3_id_accuracy_flag', '_metadata_alt01_acc_flag3_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'accuracy_flag', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('google_address', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Location', 'location3_id', 'location3_id_google_address', '_metadata_alt01_location3_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'google_address', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            
            //
            // Edit column for document3_id field
            //
            $editor = new DynamicCombobox('document3_id_edit', $this->CreateLinkBuilder());
            $editor->setAllowClear(true);
            $editor->setMinimumInputLength(0);
            $lookupDataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Document', 'document3_id', 'document3_id_id', '_metadata_alt01_document3_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'id', '');
            $editColumn->setNestedInsertFormLink(
                $this->GetHandlerLink(metadata_alt01_document3_idNestedPage::getNestedInsertHandlerName())
            );
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Image', 'image_id', 'image_id_id', '_metadata_alt01_image_id_search', $editor, $this->dataset, $lookupDataset, 'id', 'id', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_metadata_alt01_document1_id_search', 'id', 'id', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('accuracy_flag', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_acc_flag2_id_search', 'id', 'accuracy_flag', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('google_address', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_location2_id_search', 'id', 'google_address', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_document2_id_search', 'id', 'id', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('accuracy_flag', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_acc_flag3_id_search', 'id', 'accuracy_flag', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('google_address', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_location3_id_search', 'id', 'google_address', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_document3_id_search', 'id', 'id', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('id', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, '_metadata_alt01_image_id_search', 'id', 'id', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            new metadata_alt01_document1_idNestedPage($this, GetCurrentUserPermissionSetForDataSource('metadata_alt01.document1_id'));
            new metadata_alt01_document2_idNestedPage($this, GetCurrentUserPermissionSetForDataSource('metadata_alt01.document2_id'));
            new metadata_alt01_document3_idNestedPage($this, GetCurrentUserPermissionSetForDataSource('metadata_alt01.document3_id'));
        }
    ...
    try
    {
        $Page = new metadata_alt01Page("metadata_alt01", "metadata_page.php", GetCurrentUserPermissionSetForDataSource("metadata_alt01"), 'UTF-8');
